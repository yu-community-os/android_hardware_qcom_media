...
libmm-vidc-inc      += $(TOP)/hardware/qcom/media/$(QCOM_HARDWARE_VARIANT)/mm-core/inc
libmm-vidc-inc      += $(TARGET_OUT_HEADERS)/qcom/display
libmm-vidc-inc      += $(TOP)/hardware/qcom/media/$(QCOM_HARDWARE_VARIANT)/libc2dcolorconvert
